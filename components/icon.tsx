...
export function HelpSupport({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
    <MdOutlineHelpOutline {...props} />
  )
}
...
export function Feedback({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
    <RiFeedbackLine {...props} />
  )
}
...
export function UserIcon({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
    <UserGroupIcon {...props} />
  )
}
export function MarketplaceIcon({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
    <BuildingStorefrontIcon {...props} />
  )
}

export function GamingIcon({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
    <RiGamepadLine {...props} />
  )
}
export function SeeAllIcon({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
    <Squares2X2Icon {...props} />
  )
}
export function StoryIcon({ ...props }: React.SVGAttributes<SVGSVGElement>) {
  return (
