        ...
        {comments.comments.map((comment, index) => (
          <li key={index}>
            ...
            <div className='relative'>
              ...
              {/* {comments.comments.replies.length > 0 && (

                <div className='absolute  h-[calc(100%-43px)] bg-comment-bg w-[2px] top-[43px] left-[30px]'>
                </div>
              )} */}

              <Comment comments={comment} className='pl-4 pt-1 flex  relative' aria-label='Comment by who' commentText='How have you bene bro ?' />
              {/* replis */}
              ...
              <ul>
                ...
                <li className='p-0 m-0 flex flex-col'>
                  <div className='relative pl-[54px]'>
                    ...
                    <Comment comments={comment} className='pl-2 pt-1 flex  relative' aria-label='Comment by who' commentText="How are you" />
                  </div>
