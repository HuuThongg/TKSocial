import { mysqlTable, mysqlSchema, AnyMySqlColumn, index, primaryKey, serial, int, text, timestamp, varchar, tinyint, json, mysqlEnum } from "drizzle-orm/mysql-core"
...
export const usersToConversations = mysqlTable("usersToConversations", {
